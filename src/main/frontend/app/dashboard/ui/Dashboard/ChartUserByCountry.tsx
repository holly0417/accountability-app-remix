...
const StyledText = styled('text', {
    ...
    textAnchor: 'middle', dominantBaseline: 'central', fill: (theme.vars || theme).palette.text.secondary, variants: [{
        props: {
            variant: 'primary',
        }, style: {
        ...
        props: ({variant}) => variant !== 'primary', style: {
...
export default function ChartUserByCountry() {
    ...
    const data = allDataCorrectDates.map((item) => {
        ...
        return {
            label: item.username, value: eachBalance
        }
    })
    ...
    return (<Card
        ...
        >
            <CardContent>
                ...
                {countries.map((country, index) => (<Stack
                        key={index}
                        direction="row"
