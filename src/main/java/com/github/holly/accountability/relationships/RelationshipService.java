...
public class RelationshipService {
    ...
    public Page<RelationshipDto> getRelationshipsByStatus(Long currentUserId,
        ...
        if (directions.equals(List.of(RelationshipDirection.REQUESTER))) {
            return relationshipRepository
                    .getRelationshipsByStatusAndUserAsRequester(
        ...
        if (directions.equals(List.of(RelationshipDirection.RECIPIENT))) {
            return relationshipRepository
                    .getRelationshipsByStatusAndUserAsRecipient(
                            currentUserId, statuses, pageable)
                    .map(relationship -> convertRelationshipToRelationshipDto(relationship.flipped()));
        }
    ...
    public RelationshipDto sendRequest(Long currentUserId, Long partnerId) {
        ...
        Relationship newRequest =
                new Relationship(thisUser, partner, RelationshipStatus.PENDING);
